  ...
  React.useEffect(() => {
    async function load() {
      ...
      try {
        ...
        setCourse(
          courseSnap.exists() ? (courseSnap.data() as any) : null
        )
      } catch (e: any) {
          ...
          {recordings.length ? (
            recordings.map((recording, index) => (
              <Card
                ...
                className="border-border bg-card hover:border-palm/30"
              >
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button onClick={() => handleWatch(recording)}>
                    Watch
                  </Button>
                </CardContent>
              </Card>
            ...
            <Card className="border-border/70 sm:col-span-2 lg:col-span-3">
              <CardContent className="py-6 text-sm text-mutedForeground">
